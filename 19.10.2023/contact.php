...
if (isset($_GET['error'])) {
    ...
    switch($error) {
        case '1':
            $errorMessage = 'W formularsz brakuje danych';
            break;
        case '2':
            $errorMessage = 'Adres e-mail blablablabla';
            break;
        case '3':
            $errorMessage = "Wiadomosc musi miec min 20znak';
            break;
        case '4':
    ...
    */
    ...
    $errorMessage = match($error) {
        ...
        '2' => 'Adres e-mail blablablabla',
        '3' => 'Wiadomość musi mieć minimum 20 zankow',
...
<div class="container-fluid p-0">
    ...
    <div class="container py-5">
        ...
        <form id="contact-form" method="post" action="./include/formHandler.php">
            ...
            <button type="submit" class="btn btn-primary" name="sumbit">Wyślij</button>
        </form>
        <?php
        endif;
        ?>
